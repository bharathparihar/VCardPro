...
class VcardController extends AppBaseController
{
    ...
    public function edit(Vcard $vcard, Request $request)
    {
        ...
        return view('vcards.edit', compact('appointmentDetail', 'privacyPolicy', 'termCondition', 'iframes', 'managesection', 'instagramEmbed', 'banners', 'dynamicVcard', 'customLink','adminFavicon','services','appointmentServices'))->with($data);
    }
